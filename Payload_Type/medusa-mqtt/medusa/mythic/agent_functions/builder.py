...
class Medusa(PayloadType):
    ...
    name = "medusa-mqtt" 
    file_extension = "py"
    author = "@ajpc500 mods by @grampae"
    supported_os = [  
    ...
    note = "This payload uses Python to create a simple mqtt agent"
    ...
    build_parameters = [
        ...
        BuildParameter(
            ...
            parameter_type=BuildParameterType.ChooseOne,
            description="XOR the agent code",
            choices=["Yes", "No"],
            default_value="No"
        ),
        BuildParameter(
    ...
    agent_icon_path = agent_path / "medusa.png"
